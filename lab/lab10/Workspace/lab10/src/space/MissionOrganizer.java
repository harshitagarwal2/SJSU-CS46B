...
public class MissionOrganizer implements Iterable<Mission>
{
	...
	{
		ArrayList<Mission> idkbro = new ArrayList<>();
		idkbro.addAll(cheapMissions);
		idkbro.addAll(expensiveMissions);
		return idkbro.iterator();
	}
	...
	private final static Mission[]		TEST_MISSIONS =
	{
        ...
        new Mission("Europa", 5E11f),
        new Mission("Titan",8.5E11f),
        new Mission("Pluto",2.0E12f),
        new Mission("Oort Cloud",4.0E12f)
	};
